...
OutputFolder = ['/Volumes/BryJC_Stanford/Data/Cleaned_Data_Kausi/MedRes_ControlCase/','/justdata/TILING/'];
...
TIFs_PATH = {'/Volumes/BryJC_Stanford/Data/Cleaned_Data_Kausi/MedRes_ControlCase/NoAuBGFFtDenoised_New_(Set1)/no_fftnoise_3X',...
'/Volumes/BryJC_Stanford/Data/Cleaned_Data_Kausi/MedRes_ControlCase/NoAuBGFFtDenoised_New_(Set2)/no_fftnoise_3X',...
'/Volumes/BryJC_Stanford/Data/Cleaned_Data_Kausi/MedRes_ControlCase/NoAuBGFFtDenoised_New_(Set3)/no_fftnoise_3X'};
