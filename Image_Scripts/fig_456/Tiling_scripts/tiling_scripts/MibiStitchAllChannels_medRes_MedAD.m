...
OutputFolder = ['/Volumes/BryJC_Stanford/Data/Cleaned_Data_Kausi/MedRes_MedADCase/obj_images/DGtoCA1_Neurons_MetaDisease/MedAD/anatomy_and_clustered', '/TILING/'];
...
TIFs_PATH = '/Volumes/BryJC_Stanford/Data/Cleaned_Data_Kausi/MedRes_MedADCase/obj_images/DGtoCA1_Neurons_MetaDisease/MedAD/anatomy_and_clustered'; 
dataSize = 512; % Resolution of one frame

% Stitch start and end points.
startPoint = 0; % Start stitching from this point number
endPoint = 259; % End stitching with this point number. Zero means all points to the end
...
yNumPoint = 13; % Set this to the number of columns
