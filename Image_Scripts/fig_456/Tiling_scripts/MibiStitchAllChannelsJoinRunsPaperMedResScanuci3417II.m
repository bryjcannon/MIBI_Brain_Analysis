...
OutputFolder = [pwd,'/StitchedFUNMedADCaserow4col2'];
...
TIFs_PATH = {'/Volumes/KausaliaHD/AllProjects/BRAIN DATA/MIBI/MIBIData Matlab/May_June2019/MedResScan_uci3417IIFinal/190602MedResScanADuci3417II/corrected'};%, ...
...
for channelNonChar = allChannels
    ...
    MibiStitchLoopSupportJoinRunPaperMedResScanuci3417II;
end
