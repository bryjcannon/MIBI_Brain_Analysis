...
%cycle through Set1, Set2, Set3 to extract all Control points - will also
%need to change line 48
base_dir = '/Volumes/BryJC_Stanford/Data/Cleaned_Data_Kausi/MedRes_ControlCase/NoAuBGFFtDenoised_New_(Set3)/';
...
for pointNumber = 1:NumPoints
    ...
    probNuc = double(imread([deepPath, 'Ctrl3_Point', num2str(pointNumber), '_pixel_interior_smoothed_1.tiff']));
