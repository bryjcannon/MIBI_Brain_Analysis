...
base_dir = '/Volumes/BryJC_Stanford/Data/Cleaned_Data_Kausi/MedRes_MedADCase/NoAuBGFFtDenoised_New/';
...
for pointNumber = 1:NumPoints
    ...
    pointNumber = pointNumber-1; % done because MedAD med res starts at Point0
    ...
    probNuc = double(imread([deepPath, 'MedAD_Point', num2str(pointNumber), '_pixel_interior_smoothed_1.tiff']));
