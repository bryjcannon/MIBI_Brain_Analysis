...
common_name_csv = "_denovoregions_forVoronoi_expanded.csv";
...
% output folder
output_folder = "/Volumes/BryJC_Stanford/other/ForDmitry/fig6_carpet_voronoi_neurons";
