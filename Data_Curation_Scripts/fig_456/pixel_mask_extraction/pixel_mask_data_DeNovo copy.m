...
mask_types = ["1","2","3","4","5"];
num_markers = 36;
% if working with images
common_mask_name = "_submask.tif";
mask_path = "/Volumes/BryJC_Stanford/other/ForDmitry/fig6_carpet_voronoi_plaques/separated_masks_voronoi";
data_path = "/Volumes/BryJC_Stanford/other/ForDmitry/fig6_carpet/data";
% output folder
...
writetable(pixel_info_table, char(join([output_folder, '/', output_name, 'pixel_info.csv'], "")), 'Delimiter',',')
